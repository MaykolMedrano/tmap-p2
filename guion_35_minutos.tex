...
\textbf{Guion sugerido.}
\begin{quote}
La presentación tiene cuatro partes. Primero, explico la pregunta y por qué este caso es difícil de estudiar. Segundo, desarrollo la estrategia principal del paper, que es el \emph{synthetic control}. Tercero, muestro la evidencia complementaria de la tregua de 1998--1999 usando \emph{event study}. Y al final cierro con aporte, limitaciones y conclusiones.
\end{quote}
